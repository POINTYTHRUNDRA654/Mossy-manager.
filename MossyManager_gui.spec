...
"""
PyInstaller spec file for Mossy Manager GUI
...
_spec_dir = _os.abspath(_os.path.dirname(__file__)) if '__file__' in globals() else _os.getcwd()
...
_d_yaml,     _b_yaml,     _h_yaml     = collect_all('yaml')
